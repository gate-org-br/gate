...
public class Annotations
{
	...
	public static boolean exists(Class<? extends Annotation> annotation, Class<?> type, Method method)
	{
	...
	{
		return exists(annotation, screen != null ? module + "." + screen + "Screen" : module + ".Screen",
				action != null ? "call" + action : "call");
	}
			...
			String action) throws ClassNotFoundException, NoSuchMethodException
	{
		return search(annotation, screen != null
				? module + "." + screen
						+ "Screen"
				: module + ".Screen", action != null ? "call" + action : "call");
	}
}
