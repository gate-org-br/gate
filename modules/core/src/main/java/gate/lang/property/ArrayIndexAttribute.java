...
public class ArrayIndexAttribute implements Attribute
{

	private final int index;
	private final Type type;

	ArrayIndexAttribute(Type type, int index)
	{
		this.type = type;
		this.index = index;
	}
	...
	{
		return obj instanceof ArrayIndexAttribute
				&& type.equals(((ArrayIndexAttribute) obj).type)
				&& index == ((ArrayIndexAttribute) obj).index;
	}
