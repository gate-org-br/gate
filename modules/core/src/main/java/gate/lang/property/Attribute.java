...
public interface Attribute
{
	...
	default boolean isEntityId() {return false;}

	default Class<?> getElementRawType() {return Reflection.getRawType(getElementType());}
	...
	default String getRenderedValue(Object object) {return getRenderer().render(getRawType(), getValue(object));}

	default String getConvertedValue(Object object) {return getConverter().toString(getRawType(), getValue(object));}
