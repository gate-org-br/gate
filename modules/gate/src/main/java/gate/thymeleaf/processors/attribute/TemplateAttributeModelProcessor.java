...
public class TemplateAttributeModelProcessor extends AttributeModelProcessor
{
	...
	public void process(ITemplateContext context, IModel model, IElementModelStructureHandler handler)
	{
		...
		var template = (String) expression.create().evaluate(element.getAttributeValue("g:template"));
		...
		((LinkedList<IModel>) exchange.getAttributeValue("g-template-content")).add(model);
