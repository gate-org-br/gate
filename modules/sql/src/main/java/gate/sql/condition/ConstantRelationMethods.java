...
public interface ConstantRelationMethods
{
	...
	/**
	 * Adds a new predicate with the specified property reference to the current condition.
	 *
	 * @param reference the property reference to be associated with the new predicate
	 * @return the new predicate created, for chained invocations
	 * @see gate.sql.condition.Predicate
	 */
	<T, R> Predicate expression(PropertyReference<T, R> reference);
	...
	/**
	 * Adds a new negated predicate with the specified property reference to the current condition.
	 *
	 * @param reference the property reference to be associated with the new predicate
	 * @return the new negated predicate created, for chained invocations
	 * @see gate.sql.condition.Predicate
	 */
	<T, R> Predicate not(PropertyReference<T, R> reference);
