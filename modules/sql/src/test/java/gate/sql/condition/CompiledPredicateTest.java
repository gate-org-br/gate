...
public class CompiledPredicateTest
{
	...
	@Test
	public void shouldAppendConstantConditionWithAnd()
	{
	...
	@Test
	public void shouldAppendConstantConditionWithOr()
	{
		Condition condition = Condition
			.of("column1").eq(1)
			.or(Condition
	...
	@Test
	public void shouldAppendCompiledConditionWithAnd()
	{
		Condition condition = Condition
			.of("column1").eq(1)
			.and(Condition
	...
	@Test
	public void shouldAppendCompiledConditionWithOr()
	{
		Condition condition = Condition
			.of("column1").eq(1)
			.or(Condition
