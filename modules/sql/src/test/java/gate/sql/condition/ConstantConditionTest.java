...
public class ConstantConditionTest
{
    ...
    @Test
    public void shouldBuildConstantIsNullPredicate()
    {
    ...
    @Test
    public void shouldBuildConstantEqualityPredicate()
    {
        Condition condition = Condition
    ...
    @Test
    public void shouldBuildConstantInequalityPredicate()
    {
        Condition condition = Condition
    ...
    @Test
    public void shouldBuildConstantLessThanPredicate()
    {
        Condition condition = Condition
    ...
    @Test
    public void shouldBuildConstantLessThanOrEqualPredicate()
    {
        Condition condition = Condition
    ...
    @Test
    public void shouldBuildConstantGreaterThanPredicate()
    {
        Condition condition = Condition
    ...
    @Test
    public void shouldBuildConstantGreaterThanOrEqualPredicate()
    {
        Condition condition = Condition
    ...
    @Test
    public void shouldBuildConstantBetweenColumnsPredicate()
    {
        Condition condition = Condition
    ...
    @Test
    public void shouldBuildConstantEqualityWithTypedLiteral()
    {
        try
        {
    ...
    @Test
    public void shouldBuildConstantEqualityWithSubquery()
    {
    ...
    @Test
    public void shouldBuildConstantEqualityWithCompiledSubquery()
    {
    ...
    @Test
    public void shouldBuildConstantInequalityWithTypedLiteral()
    {
        try
        {
    ...
    @Test
    public void shouldBuildConstantInequalityWithSubquery()
    {
    ...
    @Test
    public void shouldBuildConstantInequalityWithCompiledSubquery()
    {
    ...
    @Test
    public void shouldBuildConstantLessThanWithTypedLiteral()
    {
        try
        {
    ...
    @Test
    public void shouldBuildConstantLessThanWithSubquery()
    {
    ...
    @Test
    public void shouldBuildConstantLessThanWithCompiledSubquery()
    {
    ...
    @Test
    public void shouldBuildConstantLessThanOrEqualWithObjectLiteral()
    {
    ...
    @Test
    public void shouldBuildConstantLessThanOrEqualWithTypedLiteral()
    {
        try
        {
    ...
    @Test
    public void shouldBuildConstantLessThanOrEqualWithSubquery()
    {
    ...
    @Test
    public void shouldBuildConstantLessThanOrEqualWithCompiledSubquery()
    {
    ...
    @Test
    public void shouldBuildConstantGreaterThanWithTypedLiteral()
    {
        try
        {
    ...
    @Test
    public void shouldBuildConstantGreaterThanWithSubquery()
    {
    ...
    @Test
    public void shouldBuildConstantGreaterThanWithCompiledSubquery()
    {
    ...
    @Test
    public void shouldBuildConstantGreaterThanOrEqualWithObjectLiteral()
    {
    ...
    @Test
    public void shouldBuildConstantGreaterThanOrEqualWithTypedLiteral()
    {
        try
        {
    ...
    @Test
    public void shouldBuildConstantGreaterThanOrEqualWithSubquery()
    {
    ...
    @Test
    public void shouldBuildConstantGreaterThanOrEqualWithCompiledSubquery()
    {
    ...
    @Test
    public void shouldRejectBetweenWithoutArguments()
    {
    ...
    @Test
    public void shouldBuildConstantBetweenWithObjectBounds()
    {
    ...
    @Test
    public void shouldBuildConstantBetweenWithTypedBounds()
    {
        try
        {
    ...
    @Test
    public void shouldBuildConstantBetweenWithTwoObjectBounds()
    {
        LocalDateTime min = LocalDateTime.of(1500, 4, 22, 0, 0, 0);
        LocalDateTime max = LocalDateTime.of(1989, 11, 15, 0, 0, 0);
    ...
    @Test
    public void shouldBuildConstantBetweenWithTypedValueAndBounds()
    {
        try
        {
    ...
    @Test
    public void shouldBuildConstantInPredicate()
    {
    ...
    @Test
    public void shouldBuildConstantInPredicateWithTypedValues()
    {
        try
        {
    ...
    @Test
    public void shouldBuildConstantInPredicateWithCompiledSubquery()
    {
    ...
    @Test
    public void shouldBuildConstantLikeWithTypedLiteral()
    {
        try
        {
    ...
    @Test
    public void shouldBuildConstantRegexWithTypedLiteral()
    {
        try
        {
    ...
    @Test
    public void shouldBuildConstantExistsPredicate()
    {
    ...
    @Test
    public void shouldBuildSubqueryEqualityWithObjectLiteral()
    {
        Condition condition = Condition
                .of("Role.id").eq(1)
                .and().when(true)
    ...
    @Test
    public void shouldBuildSubqueryEqualityWithColumnLiteral()
    {
    ...
    @Test
    public void shouldBuildConditionFromEntityPropertyReferences()
    {
        String expected = "Role.id = ?";
        String result = Condition.from(RoleMock.class).expression("Role.id").eq(RoleMock::getId)
                .toString();
        assertEquals(expected, result);
    }
}
