...
public interface Converter
{
	 ...
	 *
	 * @throws gate.error.ConversionException if the specified string can't be converted to it's
	 ...
	 * @throws ConversionException if the specified object cannot be serialized on JSON notation
	 */
	default <T> void toJsonText(JsonWriter writer, Class<T> type, T object)
			throws ConversionException
	{
		if (object != null)
	 ...
	 *
	 * @throws ConversionException if the specified JSON string cannot be parsed into a object of
