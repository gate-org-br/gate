...
public interface Converter
{
	 ...
	 * @throws java.sql.SQLException          if a SQLException exception is thrown while retrieving the
	 *                                        object from the JDBC ResultSet
	 * @throws gate.error.ConversionException if the specified type can't be retrieved from a JDBC
	 *                                        ResultSet
	 ...
	 * @throws java.sql.SQLException if a SQLException exception is thrown while setting the
	 *                               parameters
	 */
	 ...
	 * @throws gate.error.ConversionException if the specified part can't be converted to a java
	 *                                        object
	 */
	 ...
	 * <p>
	 * The string generated by this method have all information necessary for it to be converted
	 ...
	 * Serializes the specified object on JSON notation.
	 * <p>
	 * The string generated by this method are intended to be read by humans and there is no need
	...
	static Converter getConverter(Parameter parameter)
	{
		try
		{
			return parameter.isAnnotationPresent(gate.annotation.Converter.class)
					...
					: gate.converter.Converter.getConverter(parameter.getType());
