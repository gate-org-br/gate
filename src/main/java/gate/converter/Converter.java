...
public interface Converter
{
	 ...
	 *
	 * @throws java.sql.SQLException if a SQLException exception is thrown while retrieving the object from the JDBC
	 * ResultSet
	 ...
	 * @throws gate.error.ConversionException if the specified value can't be set as parameters of a JDBC
	 * PreparedStatement
	 */
	 ...
	 * <p>
	 * The string generated by this method must have all information necessary for it to be converted back to the
	 * original object.
	 *
	 ...
	 * The object to be converted must be of the converter associated java type.
	 * <p>
	 * The string generated by this method is intended to be read by humans and there is no need for it to have enough
	 * information to restore the original object.
	 *
	 * @param type type of the object to be converted to a string
	 * @param object object to be converted to a string
	 *
	 ...
	 *
	 * @throws gate.error.ConversionException if the next element of the specified JSONReader cannot be converted to a
	 * java object of the converter associated type.
	 */
	 ...
	 * Converts the specified java object to a string.
	 * <p>
	 * The string generated by this method have all information necessary for it to be converted back to the original
	 * object.
	 *
	 * @param object object to be converted to a string
	 *
	 ...
	 *
	 * @throws ConversionException if the specified JSON string cannot be parsed into a object of the specified java
	 * type
	 *
