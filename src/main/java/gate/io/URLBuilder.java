...
public class URLBuilder
{
    ...
    /**
     * Builds a Gate URL with module, screen and action.
     *
     * @param module module name
     * @param screen screen name
     * @param action action name
     * @return built URL
     */
    public static String build(String module,
                               String screen,
                               String action)
    {
        return build(module, screen, action, (Parameters) null);
    }

    /**
     * Builds a Gate URL with module, screen, action and arguments.
     *
     * @param module    module name
     * @param screen    screen name
     * @param action    action name
     * @param arguments query string arguments
     * @return built URL
     */
    public static String build(String module,
                               String screen,
                               ...
                               String arguments)
    {
        return build(module, screen, action, Parameters.parse(arguments));
    }

    /**
     * Builds a Gate URL with module, screen, action and parameters.
     *
     * @param module    module name
     * @param screen    screen name
     * @param action    action name
     * @param arguments parameters to include
     * @return built URL
     */
    public static String build(String module,
                               String screen,
