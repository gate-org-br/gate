...
/**
 * An utility class to compress and extract zipped multipart MimeDataFile
 * objects
 */
public class Zip {

	/**
	 * Compress a stream of MimeDataFile objects into a single multipart zipped
	 * MimeDataFile
	 *
	 * @param name   the name of the zipped multipart MimeDataFile to be created
	 * @param source the stream to be compressed
	 * @return a multipart zipped MimeDataFile object containing the files from the
	 *         specified stream
	...
	/**
	 * Compress a list of MimeDataFile objects into a single multipart zipped
	 * MimeDataFile
	 *
	 * @param name   the name of the zipped multipart MimeDataFile to be created
	 ...
	 * @return a list with all the contents of the specified zipped multipart
	 *         MimeDataFile
	 ...
	 *
	 * @param source the zipped multipart MimeDataFile to be extracted
	 * @return a Stream with all the contents of the specified zipped multipart
	 *         MimeDataFile
	 * @throws IOException if an IOException occurs during the extraction process
	 */
	public static Stream<MimeDataFile> stream(MimeDataFile source) throws IOException {
		try {
			ZipInputStream zipInputStream = new ZipInputStream(new ByteArrayInputStream(source.getData()));
