...
public class Credentials
{
	...
	public static String create(JsonObject claims)
	{
		return Jwts.builder()
	...
	public static JsonObject parse(String token) throws UnauthorizedException
	{
		try
		{
			return Jwts.parser()
		...
		{
			throw new UnauthorizedException("Error validate signature");
