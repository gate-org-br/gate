		...
		CompiledConditionMethods
{
	 ...
	 */
	@Override
	public <T, R> ConstantPredicate and(PropertyReference<T, R> reference)
	{
	 ...
	 */
	@Override
	public ConstantPredicate or(String expression)
	{
	 ...
	 */
	@Override
	public <T, R> ConstantPredicate or(PropertyReference<T, R> reference)
	{
