...
public class TypedInsert<T> implements Insert, Operation.Builder<T>
{
	...
	/**
	 * Creates an full insert sentence for the specified java class.
	 *
	 * @return full insert sentence for the specified java class
	 */
	@Override
	...
	public class Generic implements Operation.Builder<T>
	{
		...
		{
			return "insert into " + EntityHelper.getFullTableName(type) + " " + columns + " values " + parameters;
		}
	}
}
