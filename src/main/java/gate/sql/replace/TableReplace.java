 ...
 */
public class TableReplace implements Replace
{
	...
	/**
	 * Binds the replacement statement to a list of entities.
	 *
	...
	/**
	 * Replace sentence builder for a table with no values specified.
	 */
