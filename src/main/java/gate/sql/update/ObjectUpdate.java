...
public class ObjectUpdate<T> implements Update
{
    ...
    /**
     * Adds a new column/value pair, extracting the value from the bound object.
     *
     * @param property property reference used to resolve column name and value
    ...
    /**
     * Adds new column/value pairs, extracting all values from the bound object.
     *
