...
public class TableUpdate implements Update
{
    ...
    public <T> Compiled setFields(Class<T> type, Consumer<T> setter)
    {
        ...
        var proxy = Proxy.create(type, compiled::set);
        setter.accept(proxy);
        return compiled;
    }
    ...
    {
        var compiled = new Compiled();
        var proxy = Proxy.create(object, compiled::set);
        setter.accept(proxy);
        return compiled;
    }
    ...
    public class Generic implements Sentence.Builder
    {
        ...
        public class DisabledWhen extends When
        {
            ...
            /**
             * Ignores the specified column and keeps current builder unchanged.
             *
             * @param column the column to be updated
            ...
            /**
             * Ignores the specified typed column and keeps current builder unchanged.
             *
             * @param type   type of the column to be updated
             * @param column the column to be updated
    ...
    public class Compiled implements Sentence.Compiled.Builder
    {
        ...
        public Compiled set(String column, Object value)
        {
            if (value != null) return set((Class<Object>) value.getClass(), column, value);
        ...
        {
            values.add(value);
            Converter.getConverter(type).getColumns(column).map(e -> e + " = ?").forEach(columns::add);
            return this;
        }
        ...
        public class DisabledWhen extends When
        {
            ...
            /**
             * Ignores the specified lazy column/value pair and keeps current builder unchanged.
             *
             * @param column   the column to be added
             * @param supplier the supplier of the value associated
             * @return the current compiled builder unchanged
             ...
             * @param column the column to be added
             * @param value  the value associated
             * @param <T>    type of the column to be added
             * @return the current compiled builder unchanged
             */
            @Override
            public <T> Compiled set(Class<T> type, String column, T value)
            ...
            /**
             * Ignores the specified typed lazy column/value pair and keeps current builder unchanged.
             *
             * @param type     type of the column to be added
             * @param column   the column to be added
             * @param supplier the supplier of the value associated
    ...
    public class Prepared<E> implements Sentence.Extractor.Compiled.Builder<E>
    {
        ...
        public Sentence.Extractor.Compiled.Builder<E> where(ConstantCondition condition)
        {
            return new Sentence.Extractor.Compiled.Builder<>()
            {
                ...
                public String toString()
                {
                    return Prepared.this + " where " + condition;
                }
            };
        }
        ...
        {
            @SuppressWarnings("unchecked") var parameters = Stream.concat(extractors.stream(), condition.getParameters().map(e -> (Function<E, ?>) e)).toList();
        ...
        public class DisabledWhen extends When
        {
            ...
            /**
             * Ignores the specified column/extractor pair and keeps current builder unchanged.
             *
             * @param column    the column to be added
             * @param extractor the extractor associated
             * @return the current prepared builder unchanged
             */
            @Override
            public Prepared<E> set(String column, Function<E, Object> extractor)
            {
            ...
            /**
             * Ignores the specified typed column/extractor pair and keeps current builder unchanged.
             *
             * @param type      type of the column to be added
             * @param column    the column to be added
             * @param extractor the extractor associated
    ...
    /**
     * Conditional helper for table update builders.
     */
    public class When
    {
        ...
        /**
         * Returns the current SQL update sentence.
         *
         * @return the current SQL update sentence
         */
        @Override
        public String toString()
        {
    ...
    /**
     * Conditional helper for ignored branches on table update builders.
     */
    public class DisabledWhen extends When
    {

        /**
         * Ignores the specified column and returns an empty generic builder.
         *
         * @param column the column to be updated
        ...
        /**
         * Ignores the specified typed column and returns an empty generic builder.
         *
         * @param type   type of the column to be updated
         * @param column the column to be updated
         * @param <T>    type of the column to be updated
        ...
        /**
         * Ignores the specified lazy column/value pair and returns an empty compiled builder.
         *
         * @param column   the column to be added
         * @param supplier the supplier of the value associated
         * @return an empty compiled builder
        ...
        /**
         * Ignores the specified typed lazy column/value pair and returns an empty compiled builder.
         *
         * @param type     type of the column to be added
         * @param column   the column to be added
         * @param supplier the supplier of the value associated
