...
public class Icons
{
	...
	private Icons()
	{
		...
		models.add(new Icon("2300", "??????"));
		models.add(new Icon("2301", "??????"));
		models.add(new Icon("2302", "??????"));
		models.add(new Icon("2303", "??????"));
		models.add(new Icon("2304", "??????"));
		models.add(new Icon("2305", "??????"));
		models.add(new Icon("2306", "??????"));
		models.add(new Icon("2307", "??????"));
		models.add(new Icon("2308", "??????"));
		models.add(new Icon("2309", "??????"));
		models.add(new Icon("2310", "??????"));
		models.add(new Icon("2311", "??????"));
		models.add(new Icon("2312", "??????"));
		models.add(new Icon("2313", "??????"));
