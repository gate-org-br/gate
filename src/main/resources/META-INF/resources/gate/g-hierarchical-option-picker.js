...
export default class GHierarchicalOptionPicker extends GWindow
{
	constructor()
	{
		super();
	...
	static pick(options, caption)
	{
		if (typeof options === "string")
			return fetch(options)
				...
				}).then(result => GHierarchicalOptionPicker.pick(result, caption));

		let picker = window.top.document.createElement("g-hierarchical-option-picker");
...
customElements.define('g-hierarchical-option-picker', GHierarchicalOptionPicker);