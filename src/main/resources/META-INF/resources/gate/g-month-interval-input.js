import GMonthIntervalPicker from './g-month-interval-picker.js';

customElements.define('g-month-interval-input', class extends HTMLInputElement
{
	constructor()
	{
		super();
