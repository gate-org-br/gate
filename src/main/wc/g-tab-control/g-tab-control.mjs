...
Array.from(document.querySelectorAll('div.PageControl')).forEach(e => new PageControl(e));
...
Array.from(document.querySelectorAll('div.LinkControl')).forEach(e => new LinkControl(e));