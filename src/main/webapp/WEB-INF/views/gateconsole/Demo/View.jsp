...
<g:template filename="/WEB-INF/views/FULL.jsp">
	...
	<style>
		...
		div.demo > div > div { display: flex; align-items: center; background-color: white; padding: 8px; flex-grow: 1; min-height: 100px }
		div.demo > div > div > * { flex-grow: 1; margin: 0 }
		div.demo > div > div:last-child { background-color: #EEEEEE; }
	</style>
