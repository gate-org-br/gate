...
<g:template filename="/WEB-INF/views/FULL.jsp">
    ...
    <g:choose>
        <g:when condition="${screen.GET}">
            <fieldset>
                <ul class='DESKTOP'>
                    <g:deskitem module="gateconsole.screen" screen="Org" icon="gate.entity.Org">
                        Organiza&ccedil;&atilde;o
                    </g:deskitem>
                    <g:deskitem module="gateconsole.screen" screen="App" icon="gate.entity.App">
                        Aplica&ccedil;&otilde;es
                    </g:deskitem>
                    <g:deskitem module="gateconsole.screen" screen="Role" icon="gate.entity.Role">
                        Perfis
                    </g:deskitem>
                    <g:deskitem module="gateconsole.screen" screen="User" icon="gate.entity.User">
                        Usu&aacute;rios
                    </g:deskitem>
                    <g:deskitem module="gateconsole.screen" screen="Icon" icon="2009">
                        &Iacute;cones
                    </g:deskitem>
                    <g:deskitem module="gateconsole.screen" screen="Mail" icon="gateconsole.screen.MailScreen">
                        Fila de E-Mails
                    </g:deskitem>
                    <g:deskitem module="gateconsole.screen" screen="Subscription" icon="2002">
                        Requisi&ccedil;&otilde;es de Cadastro
                    </g:deskitem>
                    <g:deskitem icon="2007">
                        Sair do Sistema
                    </g:deskitem>
                </ul>
            </fieldset>
