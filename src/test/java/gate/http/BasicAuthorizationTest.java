...
public class BasicAuthorizationTest
{
	...
	{
		assertThrows(InvalidUsernamePasswordException.class, () -> BasicAuthorization.from(" ", "secret"));
		assertThrows(InvalidUsernamePasswordException.class, () -> BasicAuthorization.from("john", " "));
	}
}