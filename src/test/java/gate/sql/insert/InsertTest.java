...
public class InsertTest
{
    ...
    @Test
    public void testGenericTableBuilderWithPropertyReference() throws SQLException, ConstraintViolationException
    {
        try (Link link = TestDataSource.getLink())
        {
            ID id = ID.valueOf(52);
    ...
    @Test
    public void testGenericTableBuilderWithPropertyReferenceList() throws SQLException, ConstraintViolationException
    {
        try (Link link = TestDataSource.getLink())
        {
            ID id = ID.valueOf(53);
    ...
    @Test
    public void testCompiledTableBuilderWithPropertyReference() throws SQLException, ConstraintViolationException
    {
        try (Link link = TestDataSource.getLink())
        {
            ID id = ID.valueOf(54);
    ...
    @Test
    public void testCompiledTableBuilderWithObjectAndPropertyReferences() throws SQLException, ConstraintViolationException
    {
        try (Link link = TestDataSource.getLink())
        {
    ...
    @Test
    public void testObjectInsertBuilderWithPropertyReferences() throws SQLException, ConstraintViolationException
    {
        try (Link link = TestDataSource.getLink())
        {
            Person person = new Person()
